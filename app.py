...
# python_jobs = results.find_all("h2", string="Python") #Allows you to find the specifc string with limitations. IT look sfor the EXACT string (whitespace, spelling, case will effect the results)
